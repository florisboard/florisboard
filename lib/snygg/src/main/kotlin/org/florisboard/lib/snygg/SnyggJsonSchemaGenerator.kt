...
object SnyggJsonSchemaGenerator {
    ...
    fun main(args: Array<String>) {
        ...
        val jsonSchema = mapWithoutBlankValuesOf(
    ...
    private fun mapWithoutBlankValuesOf(vararg pairs: Pair<String, Any>): Map<String, Any> {
        return mapOf(*pairs).filterValues { it !is String || it.isNotBlank() }
    }
