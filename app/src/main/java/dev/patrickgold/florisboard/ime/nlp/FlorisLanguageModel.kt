...
open class FlorisLanguageModel : LanguageModel<String, Int> {
    override fun getNextTokenPredictions(
...
class FlorisMutableLanguageModel : FlorisLanguageModel(), MutableLanguageModel<String, Int> {
    override fun trainNextWordPredictions(
        precedingTokens: List<Token<String>>,
