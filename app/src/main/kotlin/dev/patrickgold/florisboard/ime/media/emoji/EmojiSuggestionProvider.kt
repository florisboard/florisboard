...
import dev.silo.omniboard.ime.nlp.EmojiSuggestionCandidate
...
class EmojiSuggestionProvider(private val context: Context) : SuggestionProvider {
    override val providerId = "org.omniboard.nlp.providers.emoji"

    private val prefs by OmniPreferenceStore
    private val lettersRegex = "^[A-Za-z]*$".toRegex()

    private val cachedEmojiMappings = Cache.Builder().build<OmniLocale, EmojiDataBySkinTone>()
