...
fun QuickActionsOverflowPanel() {
    ...
    val dynamicActionsCountToShow = (actionArrangement.dynamicActions.size -
        keyboardManager.smartbarVisibleDynamicActionsCount).coerceIn(actionArrangement.dynamicActions.indices)
