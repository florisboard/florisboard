...
class FlorisSpellCheckerService : SpellCheckerService() {
    ...
    override fun onCreate() {
        flogInfo(bha.keys.smartype.lib.devtools.LogTopic.SPELL_EVENTS)
    ...
    private inner class FlorisSpellCheckerSession : Session() {
        ...
        override fun onCreate() {
            flogInfo(bha.keys.smartype.lib.devtools.LogTopic.SPELL_EVENTS) { "Session requested locale: $locale" }
        ...
        override fun onGetSuggestions(textInfo: TextInfo?, suggestionsLimit: Int): SuggestionsInfo {
            flogInfo(bha.keys.smartype.lib.devtools.LogTopic.SPELL_EVENTS) { "text=${textInfo?.text}, limit=$suggestionsLimit" }
