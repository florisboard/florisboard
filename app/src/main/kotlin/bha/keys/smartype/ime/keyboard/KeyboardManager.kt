...
package bha.keys.smartype.ime.keyboard
...
import bha.keys.smartype.FlorisImeService
import bha.keys.smartype.R
import bha.keys.smartype.app.florisPreferenceModel
import bha.keys.smartype.appContext
import bha.keys.smartype.clipboardManager
import bha.keys.smartype.editorInstance
...
import bha.keys.smartype.ime.core.SubtypePreset
import bha.keys.smartype.ime.editor.EditorContent
import bha.keys.smartype.ime.editor.FlorisEditorInfo
import bha.keys.smartype.ime.editor.ImeOptions
import bha.keys.smartype.ime.editor.InputAttributes
import bha.keys.smartype.ime.input.CapitalizationBehavior
import bha.keys.smartype.ime.input.InputEventDispatcher
import bha.keys.smartype.ime.input.InputKeyEventReceiver
import bha.keys.smartype.ime.input.InputShiftState
import bha.keys.smartype.ime.nlp.ClipboardSuggestionCandidate
import bha.keys.smartype.ime.nlp.PunctuationRule
import bha.keys.smartype.ime.nlp.SuggestionCandidate
import bha.keys.smartype.ime.onehanded.OneHandedMode
import bha.keys.smartype.ime.popup.PopupMappingComponent
import bha.keys.smartype.ime.text.composing.Composer
import bha.keys.smartype.ime.text.gestures.SwipeAction
import bha.keys.smartype.ime.text.key.KeyCode
import bha.keys.smartype.ime.text.key.KeyType
import bha.keys.smartype.ime.text.key.UtilityKeyAction
import bha.keys.smartype.ime.text.keyboard.TextKeyData
import bha.keys.smartype.ime.text.keyboard.TextKeyboardCache
...
import bha.keys.smartype.lib.titlecase
import bha.keys.smartype.lib.uppercase
import bha.keys.smartype.lib.util.InputMethodUtils
import bha.keys.smartype.nlpManager
import bha.keys.smartype.subtypeManager
                ...
                when (activeState.keyboardMode) {
                    ...
                    KeyboardMode.PHONE2 -> when (data.type) {
                        ...
                        KeyType.CHARACTER, KeyType.NUMERIC ->{
                            ...
                            flogError(bha.keys.smartype.lib.devtools.LogTopic.KEY_EVENTS) { "Received unknown key: $data" }
                        }
                    }
                }
                if (activeState.inputShiftState != InputShiftState.CAPS_LOCK && !inputEventDispatcher.isPressed(KeyCode.SHIFT)) {
