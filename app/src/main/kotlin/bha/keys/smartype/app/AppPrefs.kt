...
import bha.keys.smartype.app.settings.theme.DisplayKbdAfterDialogs
import bha.keys.smartype.app.settings.theme.SnyggLevel
import bha.keys.smartype.app.setup.NotificationPermissionState
import bha.keys.smartype.ime.clipboard.CLIPBOARD_HISTORY_NUM_GRID_COLUMNS_AUTO
import bha.keys.smartype.ime.core.DisplayLanguageNamesIn
import bha.keys.smartype.ime.core.Subtype
import bha.keys.smartype.ime.input.CapitalizationBehavior
import bha.keys.smartype.ime.input.HapticVibrationMode
import bha.keys.smartype.ime.input.InputFeedbackActivationMode
import bha.keys.smartype.ime.keyboard.IncognitoMode
import bha.keys.smartype.ime.keyboard.SpaceBarMode
import bha.keys.smartype.ime.landscapeinput.LandscapeInputUiMode
import bha.keys.smartype.ime.media.emoji.EmojiHairStyle
import bha.keys.smartype.ime.media.emoji.EmojiHistory
import bha.keys.smartype.ime.media.emoji.EmojiSkinTone
import bha.keys.smartype.ime.media.emoji.EmojiSuggestionType
import bha.keys.smartype.ime.nlp.SpellingLanguageMode
import bha.keys.smartype.ime.onehanded.OneHandedMode
import bha.keys.smartype.ime.smartbar.CandidatesDisplayMode
import bha.keys.smartype.ime.smartbar.ExtendedActionsPlacement
import bha.keys.smartype.ime.smartbar.IncognitoDisplayMode
import bha.keys.smartype.ime.smartbar.SmartbarLayout
import bha.keys.smartype.ime.smartbar.quickaction.QuickAction
import bha.keys.smartype.ime.smartbar.quickaction.QuickActionArrangement
import bha.keys.smartype.ime.smartbar.quickaction.QuickActionJsonConfig
import bha.keys.smartype.ime.text.gestures.SwipeAction
import bha.keys.smartype.ime.text.key.KeyCode
import bha.keys.smartype.ime.text.key.KeyHintConfiguration
import bha.keys.smartype.ime.text.key.KeyHintMode
import bha.keys.smartype.ime.text.key.UtilityKeyAction
import bha.keys.smartype.ime.text.keyboard.TextKeyData
import bha.keys.smartype.ime.theme.ThemeMode
import bha.keys.smartype.ime.theme.extCoreTheme
import bha.keys.smartype.lib.compose.ColorPreferenceSerializer
import bha.keys.smartype.lib.ext.ExtensionComponentName
import bha.keys.smartype.lib.observeAsTransformingState
import bha.keys.smartype.lib.util.VersionName
        ...
        return when (entry.key) {
            ...
            "media__emoji_recently_used" -> {
                ...
                val recent = emojiValues.map {
                    bha.keys.smartype.ime.media.emoji.Emoji(it, "", emptyList())
                }
