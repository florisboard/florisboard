...
package bha.keys.smartype.app.settings.advanced
...
import bha.keys.smartype.BuildConfig
...
import bha.keys.smartype.lib.io.FileRegistry
...
fun BackupScreen() = FlorisScreen {
    ...
    fun prepareBackupWorkspace() {
        ...
        workspace.metadata = Backup.Metadata(
            packageName = bha.keys.smartype.BuildConfig.APPLICATION_ID,
            versionCode = bha.keys.smartype.BuildConfig.VERSION_CODE,
            versionName = bha.keys.smartype.BuildConfig.VERSION_NAME,
