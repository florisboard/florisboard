...
package bha.keys.smartype.app.settings.localization
...
import bha.keys.smartype.ime.core.SubtypeJsonConfig
import bha.keys.smartype.ime.core.SubtypeLayoutMap
import bha.keys.smartype.ime.core.SubtypeNlpProviderMap
import bha.keys.smartype.ime.core.SubtypePreset
import bha.keys.smartype.ime.keyboard.LayoutArrangementComponent
import bha.keys.smartype.ime.keyboard.LayoutType
import bha.keys.smartype.ime.keyboard.extCorePopupMapping
import bha.keys.smartype.ime.nlp.han.HanShapeBasedLanguageProvider
import bha.keys.smartype.ime.nlp.latin.LatinLanguageProvider
import bha.keys.smartype.keyboardManager
import bha.keys.smartype.lib.FlorisLocale
import bha.keys.smartype.lib.compose.FlorisButtonBar
import bha.keys.smartype.lib.compose.FlorisDropdownMenu
...
import bha.keys.smartype.lib.compose.FlorisDropdownLikeButton
                            ...
                            for (suggestedPreset in suggestedPresets) {
                                JetPrefListItem(
                                    ...
                                    text = when (displayLanguageNamesIn) {
                                        ...
                                        else -> suggestedPreset.locale.displayName()
                                    },
                        ...
                        items(subtypePresets) { subtypePreset ->
                            JetPrefListItem(
                                ...
                                text = when (displayLanguageNamesIn) {
                                    ...
                                    else -> subtypePreset.locale.displayName()
                                },
