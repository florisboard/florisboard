...
package bha.keys.smartype.app.settings.about
...
import bha.keys.smartype.lib.compose.FlorisCanvasIcon
...
fun AboutScreen() = FlorisScreen {
    ...
    val appVersion = "${bha.keys.smartype.BuildConfig.VERSION_NAME} (${bha.keys.smartype.BuildConfig.VERSION_CODE})"
    ...
    content {
        ...
        Preference(
            ...
            onClick = { context.launchUrl(R.string.florisboard__changelog_url, "version" to bha.keys.smartype.BuildConfig.VERSION_NAME) },
        )
        Preference(
