...
package bha.keys.smartype.lib.crashutility
...
import bha.keys.smartype.lib.devtools.Devtools
...
class CrashDialogActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        errorReport.apply {
            ...
            appendLine("- FlorisBoard $versionName (${bha.keys.smartype.BuildConfig.VERSION_CODE})")
            ...
            if (stacktraces.isNotEmpty()) {
                ...
                flogWarning(bha.keys.smartype.lib.devtools.LogTopic.CRASH_UTILITY) {
