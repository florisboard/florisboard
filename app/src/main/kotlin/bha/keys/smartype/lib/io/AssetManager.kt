...
package bha.keys.smartype.lib.io

import android.content.Context
import bha.keys.smartype.ime.keyboard.AbstractKeyData
import bha.keys.smartype.ime.keyboard.CaseSelector
import bha.keys.smartype.ime.keyboard.CharWidthSelector
import bha.keys.smartype.ime.keyboard.KanaSelector
import bha.keys.smartype.ime.keyboard.KeyData
import bha.keys.smartype.ime.keyboard.LayoutDirectionSelector
import bha.keys.smartype.ime.keyboard.ShiftStateSelector
import bha.keys.smartype.ime.keyboard.VariationSelector
import bha.keys.smartype.ime.text.keyboard.AutoTextKeyData
import bha.keys.smartype.ime.text.keyboard.MultiTextKeyData
