...
package bha.keys.smartype.lib.ext
...
import bha.keys.smartype.ime.nlp.LanguagePackExtension
import bha.keys.smartype.ime.text.composing.Appender
import bha.keys.smartype.ime.text.composing.Composer
import bha.keys.smartype.ime.text.composing.HangulUnicode
import bha.keys.smartype.ime.text.composing.KanaUnicode
import bha.keys.smartype.ime.text.composing.WithRules
...
import bha.keys.smartype.lib.io.delete
import bha.keys.smartype.lib.io.listDirs
import bha.keys.smartype.lib.io.listFiles
            ...
            ioScope.launch {
                initGuard.withLock {
                    ...
                    fileObserver = FileObserver(internalModuleDir, FILE_OBSERVER_MASK) { event, path ->
                        flogDebug(bha.keys.smartype.lib.devtools.LogTopic.EXT_INDEXING) { "FileObserver.onEvent { event=$event path=$path }" }
