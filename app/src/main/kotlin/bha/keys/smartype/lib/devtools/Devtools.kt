...
import bha.keys.smartype.app.AppPrefs
import bha.keys.smartype.extensionManager
import bha.keys.smartype.lib.titlecase
import bha.keys.smartype.lib.util.TimeUtils
import bha.keys.smartype.lib.util.UnitUtils
...
object Devtools {
    ...
    fun generateAppInfoLog(context: Context, withTitle: Boolean = true): String {
        return buildString {
            ...
            append("Package             : ").appendLine(bha.keys.smartype.BuildConfig.APPLICATION_ID)
            append("Name                : ").appendLine(context.resources.getString(R.string.floris_app_name))
            append("Version             : ").appendLine("${bha.keys.smartype.BuildConfig.VERSION_NAME} (${bha.keys.smartype.BuildConfig.VERSION_CODE})")
            append("Build type          : ").appendLine(bha.keys.smartype.BuildConfig.BUILD_TYPE)
            append("Build commit hash   : ").appendLine(bha.keys.smartype.BuildConfig.BUILD_COMMIT_HASH)
